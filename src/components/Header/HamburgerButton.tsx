...
export const HamburgerButton = (props: HamburgerButtonProps) => {
    ...
    return (
        <label role="button" aria-label="Hamburger Menu" className="btn btn-circle swap swap-rotate md:hidden z-[100]">
            {/* this hidden checkbox controls the state */}
            <input type="checkbox" onChange={(e) => setOpenNavSideBar(e.target.checked)} checked={openNavSideBar} />
